                            ...
                            <div class="rds2" style="padding: 5px 2px; border: 1px solid #ddd; background-color: #F2F8FC">
                                ...
                                <div style="float: left; margin: 5px" class="control-group ">
                                    ...
                                    <div class="input-append date form_datetime">
                                        <input readonly="true" class="input-medium" foo_bar="prevent_readonly" id="id_pickup_time_0" name="pickup_time_0" type="text" value="<%:Order.PickupTime.HasValue ? Order.PickupTime.Value.ToShortDateString() : DateTime.Today.ToString("yyyy/MM/dd") %>"  required="required"/>
