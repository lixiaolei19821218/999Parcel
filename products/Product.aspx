                                ...
                                <div style="padding-top: 10px"> 
                                    ...
                                    <div style="margin-left: 26px; float: left">
                                        <div style="float: left; margin: 5px 5px 5px 7px" class="control-group ">
                                            ...
                                            <input id="id_addr-0-phone" maxlength="12" pattern="(^1[3|4|5|7|8][0-9]\d{4,8}$)|(^((0\d{2,3}-\d{7,8})|(1[3584]\d{9}))$)|(^((0\d{2,3}\d{7,8})|(1[3584]\d{9}))$)" name="addr-<%#Container.ItemIndex %>-phone" style="width: 100px" type="text" value="<%#Item.PhoneNumber %>"  required oninvalid="setCustomValidity('请输入正确的11位手机号码或固话号码。')" oninput="setCustomValidity('')"/>
                                        </div>
                                    </div>      
